          ...
          builder: (context, provider, child) {
            ...
            switch (provider.shiftStatus) {
              case 'checkIn':
                ...
                if (provider.shouldShowCheckInReason) {
                  // The user is late, and they need to provide a reason.
                  onTap = () => _showReasonCheckIn(context);
                  // print(provider.activeShiftInfo);
                } else {
                  // The user is on time, and no reason is required.
                  provider.checkInOut("qrCode", reason: "");
                }
                break;
            ...
            return Column(
              ...
              children: [
                ...
                //! Display the active shift information
                // Center(
                //   child: Text('Shift Status: ${provider.shiftStatus ?? "N/A"}'),
                // ),
                // if (provider.shiftStatus != 'disabled')
                //   Center(child: Text(provider.activeShiftInfo)),
